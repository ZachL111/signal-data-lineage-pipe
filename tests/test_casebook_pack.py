"""Regression checks for the signal-data-lineage-pipe casebook."""
...
from casebook.harness import assert_expected, signal_data_lineage_pipe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(signal_data_lineage_pipe_summary(), assert_expected())
