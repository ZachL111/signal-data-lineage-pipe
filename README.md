...
signal-data-lineage-pipe is a C++ project for data engineering. It focuses on this technical goal: Build a C++ toolkit that studies lineage behavior through deny and allow fixtures, with explainable decision traces and local-only command execution.
